...
void ProjectSettingsDialog::SetupAIModelTab()
{
    ...
    model_path_edit_->setPlaceholderText("./models/yolo11n-seg.pt");
    ...
    model_info_label_->setStyleSheet("QLabel { padding: 10px; background-color: #f0f0f0; border-radius: 5px; }");
    ...
    // Connect signals
    connect(browse_model_button_, &QPushButton::clicked, this, [this]() {
        QString file = QFileDialog::getOpenFileName(this, "Select Model",
                                                    model_path_edit_->text(),
...
void ProjectSettingsDialog::SetupExportTab()
{
    ...
    export_format_combo_->addItem("YOLO Segmentation (default)");
    export_format_combo_->addItem("YOLO Bounding Box");
...
void ProjectSettingsDialog::SetupAdvancedTab()
{
    ...
    connect(browse_images_button_, &QPushButton::clicked, this, [this]() {
    ...
    connect(browse_labels_button_, &QPushButton::clicked, this, [this]() {
    ...
    connect(browse_models_button_, &QPushButton::clicked, this, [this]() {
